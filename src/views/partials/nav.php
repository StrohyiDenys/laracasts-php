            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" <?= isUrl("/") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
                        <a href="/about" <?= isUrl("/about") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/contact" <?= isUrl("/contact") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
                        <a href="/notes" <?= isUrl("/notes") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php if($_SESSION['user'] ?? false):?>
                        ...
                        <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                            ...
                            <img src="https://www.mirlukov.by/upload/iblock/5bb/avmwvp8gdxfav71wlew90jr3hnqw7fs5.jpg" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                        </button>
                    ...
                    <?php else:?>
                        <a href="/register" <?= isUrl("/register") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white ">Register</a>
                        <a href="/login" <?= isUrl("/login") ? "aria-current=\"page\" class=\"rounded-md bg-gray-900" : "class=\""?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Login</a>
                    <?php endif; ?>
                </div>
            </div>
